          ...
          {funding.map((fund, index) => (
            ...
            >
              <Image
                ...
                className=""
              />
              <div className="w-full h-[120px] group-hover:h-full flex items-center flex-col duration-500 bg-white absolute bottom-0 group-hover:bottom-1/5 group-hover:flex group-hover:flex-col  group-hover:items-center  left-0">
                ...
                <h3 className="text-2xl text-red-600 font-semibold p-2 text-center mt-4 group-hover:mt-24 md:group-hover:mt-24 group-hover:text-xl">
                  {fund.title}
                </h3>
